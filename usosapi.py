# A python program helping with making Usos Api requests
# Write additional functions at the end
...
SCOPES = "offline_access|student_exams|email|mailclient"
...
class USOSAPIConnection():
    ...
    #-------------------------------------------------------------------------------
    # We write additional requests here, if we need (we probably don't)
    # Write your own functions only after this point
